...
% 'Alg304_ov_TrackingValidationWithMultipleThresholds' and chooses
% the threshold that gave the lowest localization error.
...
function [] = Alg305_ov_ChoosingParametersForTesting()
...
path_to_tests = paths.path_to_second_tests_on_validation;
path_to_grid_tests = paths.path_to_grid_second_tests_on_validation;
path_to_names_test = paths.path_to_names_second_tests_on_validation;
